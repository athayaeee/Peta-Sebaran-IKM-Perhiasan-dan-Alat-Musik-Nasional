...
map.getView().fit([10804388.230035, -1018381.956061, 13605752.322470, 479408.086074], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">PETA SEBARAN IKM PERHIASAN DAN ALAT MUSIK NASIONAL</h2>';
        return titleElement;
    })(),
