...
var style_LayerIKMPERHIASANPOTENSIBINAAN_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var labelFont = "16.900000000000002px \'Playbill\', sans-serif";
    var labelFill = "#6f61ff";
    var bufferColor = "#060606";
    var bufferWidth = 9.0;
    ...
    if (size == 1) { // If cluster has one feature
        ...
        if (feature.get("IKM") !== null) {
            labelText = String(feature.get("IKM"));
        }
